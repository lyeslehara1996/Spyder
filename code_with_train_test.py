...
Model_2 = Sequential()
Model_2.add(Embedding( vocab_size,100,input_length=100))

Model_2.add(LSTM(400, return_sequences=True))
Model_2.add(Dropout(0.4))
Model_2.add(LSTM(350, return_sequences=True))
Model_2.add(Dropout(0.4))
...
Model_2.add(Dropout(0.4))
Model_2.add(LSTM(4, return_sequences= False))
...
history=Model_2.fit(review_train, label_train,  epochs=5, validation_split=0.2)
